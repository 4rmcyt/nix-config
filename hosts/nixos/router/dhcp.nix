    ...
    settings = {
      ...
      subnet4 = [
        # ── VLAN 10 — trusted ───────────────────────────────────────────
        {
          ...
          option-data = [
            { name = "routers";             data = n.vlans.trusted; }
            { name = "domain-name-servers"; data = n.vlans.trusted; }
            { name = "broadcast-address";   data = "192.168.1.255"; }
          ];
          reservations = [
            { hw-address = m.homeserver;       ip-address = n.hosts.homeserver_lan;     hostname = "homeserver"; }
            { hw-address = m.desktop-lan;      ip-address = n.hosts.desktop_lan;        hostname = "desktop"; }
            { hw-address = m.desktop-wifi;     ip-address = n.hosts.desktop_wifi;       hostname = "desktop-wifi"; }
            { hw-address = m.matebook;         ip-address = n.hosts.matebook_wifi;      hostname = "matebook"; }
        ...
        # ── VLAN 20 — iot ───────────────────────────────────────────────
        {
          ...
          option-data = [
            { name = "routers";             data = n.vlans.iot; }
            { name = "domain-name-servers"; data = n.vlans.iot; }
            { name = "broadcast-address";   data = "192.168.20.255"; }
          ];
          reservations = [
            { hw-address = m.alexa;         ip-address = n.smart-home.alexa-echo-show; hostname = "alexa"; }
            { hw-address = m.plug-entrance; ip-address = n.smart-home.plugs.entrance;  hostname = "plug-entrance"; }
            { hw-address = m.plug-salt;     ip-address = n.smart-home.plugs.salt;      hostname = "plug-salt"; }
            { hw-address = m.plug-office;   ip-address = n.smart-home.plugs.office;    hostname = "plug-office"; }
        ...
        # ── VLAN 30 — media ─────────────────────────────────────────────
        {
          ...
          option-data = [
            { name = "routers";             data = n.vlans.media; }
            { name = "domain-name-servers"; data = n.vlans.media; }
            { name = "broadcast-address";   data = "192.168.30.255"; }
          ];
          reservations = [
            { hw-address = m.ps5;             ip-address = n.entertainment.playstation-5;   hostname = "ps5"; }
            { hw-address = m.nintendo-switch; ip-address = n.entertainment.nintendo-switch; hostname = "nintendo-switch"; }
            { hw-address = m.mi-box-s;        ip-address = n.entertainment.mi-box-s;        hostname = "mi-box-s"; }
            { hw-address = m.roku-tv;         ip-address = n.entertainment.roku-tv;         hostname = "roku-tv"; }
          ];
        }
        ...
        # ── VLAN 40 — work ──────────────────────────────────────────────
        {
          ...
          option-data = [
            { name = "routers";             data = n.vlans.work; }
