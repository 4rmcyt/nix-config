{
  ...
  systemd.services.komga.serviceConfig = {
    ...
    # relaxed to 0 (see hosts/nixos/homeserver/hardening.nix). Bisected in
    # three rounds after the full block broke Tomcat's own port bind
    # ("Operation not permitted" from Net.bind0) — each block below
    # confirmed working live on its own before the next was added.
