...

{
  sops = {
    ...
    secrets = {
      ...
      tplinkExporterConfig = {
        sopsFile = ../../secrets/tplink_exporter.yaml;
        key = "";
        owner = "root";
        group = "root";
        mode = "0400";
      ...
      miniflux_creds = {
        sopsFile = ../../secrets/miniflux-creds.txt;
        key = "";
        owner = "miniflux";
        group = "miniflux";
      };
      ...
      lldap_admin_password = {
        sopsFile = ../../secrets/lldap_secrets.yaml;
        key = "lldap_initial_admin_password";
        owner = "lldap";
        group = "lldap";
        mode = "0400";
      };
