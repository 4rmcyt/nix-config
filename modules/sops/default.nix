...

{
  sops = {
    ...
    secrets = {
      ...
      lldap_cert = { sopsFile = ../../secrets/cert.pem; owner = "lldap"; group = "lldap"; mode = "0440"; format = "pem"; };
      lldap_key = { sopsFile = ../../secrets/key.pem; owner = "lldap"; group = "lldap"; mode = "0440"; format = "pem"; };
    };
  };
}