...

{
  sops = {
    ...
    secrets = {
      ...
      miniflux_credentials = { sopsFile = ../../secrets/miniflux_credentials.yaml; key = ""; owner = "miniflux"; format = "yaml"; };
      ...
      miniflux_env = { sopsFile = ../../secrets/miniflux_env.yaml; key = "DATABASE_URL"; };
