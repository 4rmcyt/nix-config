...

{
  sops = {
    ...
    secrets = {
      ...
      # --- LLDAP Secrets ---
      lldap_user_password = { sopsFile = ../../secrets/lldap_secrets.yaml; key = "lldap_user_password"; owner = "lldap"; group = "lldap"; mode = "0400";  };
      jwt_secret_file = { sopsFile = ../../secrets/lldap_secrets.yaml; key = "lldap_jwt_secret"; owner = "lldap"; group = "lldap"; mode = "0400"; };
