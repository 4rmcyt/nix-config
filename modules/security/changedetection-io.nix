...

{
  ...
  services.nginx.virtualHosts."changedetection.labhome.work" = {
    forceSSL = true;
    enableACME = true;
    extraConfig = ''
    ...
    locations."@goauthentik" = {
      return 302 https://authentik.labhome.work/outpost.goauthentik.io/start?rd=$scheme://$http_host$request_uri;
    };
  };
