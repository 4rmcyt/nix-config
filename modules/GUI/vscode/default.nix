  ...
  programs.vscode = {
    ...
    extensions = with pkgs.vscode-extensions;
      ...
      ++ (with pkgs.vscode-utils; [
        ...
        (buildVscodeExtension {vscodeExtUniqueId = "BeardedBear.beardedtheme";})
        (buildVscodeExtension {vscodeExtUniqueId = "BeardedBear.beardedicons";})
        (buildVscodeExtension {vscodeExtUniqueId = "ibecker.treefmt-vscode";})
      ]);
