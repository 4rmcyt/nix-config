...

{
 sops = {
    ...
    miniflux_db_password = { owner = config.services.postgresql.user; };
    hass_db_password          = { owner = config.services.postgresql.user; };
    keycloak_db_password       = { owner = config.services.postgresql.user; };
    nextcloud_db_password      = { owner = config.services.postgresql.user; };
