...
}:
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    tuptime smartmontools fzf ffmpeg nmap trash-cli zip unar unzip p7zip calibre calibre-web
    go nextdns nixfmt-rfc-style nil deploy-rs just nixpkgs-fmt tree git-crypt python3Full python313Packages.unidecode
  ];
